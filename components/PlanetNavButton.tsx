  ...
  return (
    ...
    >
      <div className="relative">
        <div className="w-30 h-30 md:w-30 md:h-30 rounded-full overflow-hidden bg-gray-800/50 backdrop-blur-sm border border-gray-600 group-hover:border-yellow-400 transition-all duration-300">
          <img
            src={planet.image}
            alt={planet.name}
        ...
        <div className="absolute top-0 w-30 h-30 md:w-30 md:h-30 rounded-full overflow-hidden bg-gray-800/50 backdrop-blur-sm">
          <img
            src={planet.image}
            alt={planet.name}
            className="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110"
        ...
        <div
          className={`absolute top-0 bottom-0 w-px bg-linear-to-b from-transparent via-white to-transparent ${
